...
* [Verify mass shifts from proteoforms using mass shifts from peptides](https://github.com/wenronchen/PTM-TBA/blob/master/README.md#3-preprocess-mass-shifts-from-proteoform-identifications)
